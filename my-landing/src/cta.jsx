...
export default function Cta() {
    return (
        ...
        <div className='flex flex-col items-center mt-12 sm:mt-14 gap-6'>
            <h2 className='text-[2.525rem] sm:text-[3.375rem] tracking-[-0.20rem] flex flex-col text-center  leading-[1.1] font-bold'>Ready to grow <br />  your SaaS?</h2>
